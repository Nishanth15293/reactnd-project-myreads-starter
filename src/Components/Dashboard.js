    ...
    render(){
        ...
        return(
            <div className="list-books">
                ...
                <div>
                    <BookShelf title="Currently Reading" books={allBooks} shelf="currentlyReading" />
                    <BookShelf title="Want To Read" books={allBooks} shelf="wantToRead" />
                    <BookShelf title="Read" books={allBooks} shelf="read" />
